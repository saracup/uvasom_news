<?php /*
	Template Name: Widgetized HTML Email 
*/ ?>
<?php
...
<tr>
      <td width="10" style="padding-top: 15px; padding-left: 20px; padding-right: 20px;"><table width="640" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="450" valign="top"><table style="width:450;margin-left:auto;margin-right:auto;margin-bottom:15px;" cellspacing="0" cellpadding="0" border="0">
            <tr>
            	<td valign="top">
